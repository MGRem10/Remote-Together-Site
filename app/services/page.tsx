          ...
          <div className="section-panel rounded-[2rem] p-8 md:p-10">
            ...
            <div className="mt-8 grid gap-4 sm:grid-cols-2">
              {[
                ...
                <div key={item} className="rounded-[1.4rem] bg-[rgba(255,255,255,0.48)] px-5 py-4 text-sm font-medium text-[var(--text)]">
                  {item}
                </div>
              ))}
            </div>
            ...
            {serviceItems.map((service) => (
              <article key={service.title} className="section-panel rounded-[1.9rem] p-8">
                ...
                <div className="mt-8 grid gap-5 md:grid-cols-2">
                  <div className="rounded-[1.5rem] bg-[rgba(255,255,255,0.5)] p-5">
                ...
                <div className="mt-6 rounded-[1.5rem] bg-[rgba(255,255,255,0.5)] p-6">
                  <div className="text-xs uppercase tracking-[0.18em] text-[var(--accent-deep)]">
                    What Is Included
                  </div>
      ...
      <section className="section-space section-block">
        <div className="container grid gap-8 lg:grid-cols-[0.82fr_1.18fr]">
          ...
          <div className="space-y-4">
            {serviceFaqs.map((faq) => (
              <article key={faq.question} className="section-panel rounded-[1.7rem] p-7">
